...
fun X.binding(f: F): X = x("binding", f)
...
fun X.comments(f: F): X = x("comments", f)
fun X.commenting(f: F): X = x("commenting", f)
...
fun X.compile(f: F): X = x("compile", f)
fun X.compiled(f: F): X = x("compiled", f)
fun X.compiler(f: F): X = x("compiler", f)
...
fun X.decimal(f: F): X = x("decimal", f)
...
fun X.definition(f: F): X = x("definition", f)
fun X.defined(f: F): X = x("defined", f)
...
fun X.digit(f: F): X = x("digit", f)
fun X.dimension(f: F): X = x("dimension", f)
fun X.dimensional(f: F): X = x("dimensional", f)
...
fun X.evaluator(f: F): X = x("evaluator", f)
fun X.event(f: F): X = x("event", f)
fun X.events(f: F): X = x("events", f)
fun X.exact(f: F): X = x("exact", f)
...
fun X.export(f: F): X = x("export", f)
fun X.exported(f: F): X = x("exported", f)
...
fun X.haskell(f: F): X = x("haskell", f)
...
fun X.loaded(f: F): X = x("loaded", f)
fun X.loader(f: F): X = x("loader", f)
fun X.loading(f: F): X = x("loading", f)
...
fun X.prelude(f: F): X = x("prelude", f)
...
fun X.reflection(f: F): X = x("reflection", f)
fun X.regex(f: F): X = x("regex", f)
...
fun X.repeating(f: F): X = x("repeating", f)
...
fun X.sentence(f: F): X = x("sentence", f)
...
fun X.seventh(f: F): X = x("seventh", f)
...
fun X.take(f: F): X = x("take", f)
fun X.taken(f: F): X = x("taken", f)
fun X.takes(f: F): X = x("takes", f)
fun X.taking(f: F): X = x("taking", f)
...
fun X.unlimited(f: F): X = x("unlimited", f)

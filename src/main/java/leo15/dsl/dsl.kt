...
infix fun X.align(f: F): X = x("align", f)
infix fun X.alignment(f: F): X = x("alignment", f)
...
infix fun X.category(f: F): X = x("category", f)
...
infix fun X.dollar(f: F): X = x("dollar", f)
...
infix fun X.exclamation(f: F): X = x("exclamation", f)
...
infix fun X.fail(f: F): X = x("fail", f)
infix fun X.failed(f: F): X = x("failed", f)
infix fun X.fails(f: F): X = x("fails", f)
infix fun X.failure(f: F): X = x("failure", f)
...
infix fun X.help(f: F): X = x("help", f)
...
infix fun X.invalid(f: F): X = x("invalid", f)
...
infix fun X.manual(f: F): X = x("manual", f)
...
infix fun X.mask(f: F): X = x("mask", f)
...
infix fun X.natural(f: F): X = x("natural", f)
...
infix fun X.pointer(f: F): X = x("pointer", f)
...
infix fun X.success(f: F): X = x("success", f)
...
infix fun X.try_(f: F): X = x("try", f)
...
infix fun X.valid(f: F): X = x("valid", f)
infix fun X.validate(f: F): X = x("validate", f)
...
val X.align: X get() = align { this }
val X.alignment: X get() = alignment { this }
...
val X.category: X get() = category { this }
...
val X.dollar: X get() = dollar { this }
...
val X.exclamation: X get() = exclamation { this }
...
val X.fail: X get() = fail { this }
val X.failed: X get() = failed { this }
val X.fails: X get() = fails { this }
val X.failure: X get() = failure { this }
...
val X.invalid: X get() = invalid { this }
...
val X.manual: X get() = manual { this }
...
val X.natural: X get() = natural { this }
...
val X.pointer: X get() = pointer { this }
...
val X.success: X get() = success { this }
...
val X.valid: X get() = valid { this }
val X.validate: X get() = validate { this }

...
data class Indent(val previousOrNull: Indent?, val tab: Tab) : LeoObject() {
...
fun indent(tab: Tab, vararg tabs: Tab): Indent =
...
fun Indent.plus(tab: Tab): Indent =
	Indent(this, tab)

fun Indent?.orNullPlus(tab: Tab): Indent =

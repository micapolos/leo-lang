...
fun type(vararg sentences: TypeSentence): Type = emptyType.fold(sentences) { plus(it) }
fun String.sentence(vararg sentences: TypeSentence): TypeSentence = sentenceTo(type(*sentences))
operator fun String.invoke(vararg sentences: TypeSentence): TypeSentence = sentence(*sentences)

...
fun TypeLink.match(compiledTypeLink: TypeLink, erase: Erase, recursiveOrNull: TypeRecursive?): Match =
...
fun TypeFunction.match(compiledFunction: TypeFunction, erase: Erase, recursiveOrNull: TypeRecursive?): Match =

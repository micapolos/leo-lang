...
import leo14.typed.Case
import leo14.typed.Choice
import leo14.typed.Type
import leo14.typed.Typed

sealed class Compiler<T>
data class TypedCompiler<T>(val parent: TypedParent<T>?, val typed: Typed<T>) : Compiler<T>()
...
data class MatchCompiler<T>(val parent: TypedCompiler<T>?, val term: Term<T>, val remainingCaseStack: Stack<Case>, val typeOrNull: Type?) : Compiler<T>()

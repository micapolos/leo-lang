...
val Int1.bits get() = Seq { hsb then lo.bits }
val Int2.bits get() = Seq { hsb then lo.bits }
val Int3.bits get() = Seq { hsb then lo.bits }
val Int4.bits get() = Seq { hsb then lo.bits }
val Int5.bits get() = Seq { hsb then lo.bits }
val Int6.bits get() = Seq { hsb then lo.bits }
val Int7.bits get() = Seq { hsb then lo.bits }
val Int8.bits get() = Seq { hsb then lo.bits }
val Int9.bits get() = Seq { hsb then lo.bits }
val Int10.bits get() = Seq { hsb then lo.bits }
val Int11.bits get() = Seq { hsb then lo.bits }
val Int12.bits get() = Seq { hsb then lo.bits }
val Int13.bits get() = Seq { hsb then lo.bits }
val Int14.bits get() = Seq { hsb then lo.bits }
val Int15.bits get() = Seq { hsb then lo.bits }
val Int16.bits get() = Seq { hsb then lo.bits }

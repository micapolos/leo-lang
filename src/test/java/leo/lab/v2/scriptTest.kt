...
class ScriptTest {
	...
	fun matchAnyWord() {
		...
		script(oneWord to null, twoWord to null).matchWord { this }.assertEqualTo(null)
	}
	...
	fun matchWord() {
		...
		script(oneWord to null, twoWord to null).matchWord(oneWord) { Unit }.assertEqualTo(null)
	}
	...
	fun commandStream() {
		script(
			...
			.commandStream
			.assertContains(
				begin.command(oneWord),
				begin.command(twoWord),
				end.command,
				end.command,
				begin.command(threeWord),
				end.command)
	}
}